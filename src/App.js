    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-400 to-purple-500">
      <header className="bg-white shadow-md">
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div>
            <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg mr-2 transition duration-300 ease-in-out">
              Log In
            </button>
            <button className="bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded-lg transition duration-300 ease-in-out">
              Sign Up
            </button>
          </div>
        </nav>
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        {/* Updated section: Available Flight Companions */}
        <div className="mb-16">
